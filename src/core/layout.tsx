          ...
          <form>
            <div className='search-group'>
              ...
              <label className='search-input'>
                <input type='text' id='q' name='q' maxLength={1000} placeholder={resource.keyword} value={state.keyword ? state.keyword === '?' ? '' : state.keyword : ''} style={{ paddingLeft: '12px' }} onChange={handleInput} autoComplete='off' />
